...
| **K8s admission** | ImagePolicyWebhook validates containers | Ephemeral containers bypass webhook entirely | In-process subresource gap | **VULNERABLE** | CVE-2023-2727, CVE-2023-2728, CVE-2024-3177 (CVSS 2.7 LOW) |
